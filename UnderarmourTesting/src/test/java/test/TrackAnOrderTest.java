...
public class TrackAnOrderTest {
    ...
    public void checkValidDataInTextArea() throws InterruptedException {
        ...
        TrackAnOrderPage trackAnOrderPage = (new TrackAnOrderPage(this.driver)).openPage().enterOrderNumbers("12356432")
                .inputInEmailField("liza.azazi@gmail.com").pressEnter();
